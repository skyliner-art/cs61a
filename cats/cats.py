...
def about(subject):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    def about_subject(pending_paragraph):
        for word in split(remove_punctuation(pending_paragraph)):
...
def wpm(typed, elapsed):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    cnt_typed = len(typed) / 5
    return cnt_typed / (elapsed / 60)
    # END PROBLEM 4
...
def minimum_mewtations(typed, source, limit):
    ...
    3
    """
    if limit < 0 or typed == source or source == "" or typed == "": # Base cases should go here, you may add more base cases as needed.
        # BEGIN
        "*** YOUR CODE HERE ***"
        return abs(len(typed) - len(source))
        # END
    # Recursive cases should go below here
    elif typed!="" and source!="" and typed[0] == source[0]: # Feel free to remove or add additional cases
        # BEGIN
        "*** YOUR CODE HERE ***"
...
def time_per_word(words, timestamps_per_player):
    ...
    for player_time in tpp:
        time = []
        for time_index in range(len(player_time) - 1):
            time.append(player_time[time_index + 1] - player_time[time_index])
        times.append(time)
    # END PROBLEM 9
...
def fastest_words(words_and_times):
    ...
    for word_index in word_indices:
        ...
        fastest[min_player].append(words[word_index])
    return fastest
    # END PROBLEM 10
